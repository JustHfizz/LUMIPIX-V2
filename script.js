...
/* Sesuaikan ukuran photo-box berdasarkan orientasi foto yang diupload */
function fitPhotoBox(imgWidth, imgHeight) {
  const workspace = canvasContainer.parentElement;
  ...
  if (aspect < 1) {
    const boxH = availH;
    const boxW = Math.min(boxH * aspect, availW);
    canvasContainer.style.flex   = "none";
    canvasContainer.style.width  = boxW + "px";
    canvasContainer.style.height = boxH + "px";
  } else {
